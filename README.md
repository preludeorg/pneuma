...
> This repo is for those who feel comfortable working with the inner workings of a Remote Access Trojan (RAT). If you simply need a copy of the Pneuma agent, there are precompiled versions available for [MacOS](https://s3.amazonaws.com/pneuma/), [Windows](https://s3.amazonaws.com/operator.payloads/pneuma-windows) and [Linux](https://s3.amazonaws.com/operator.payloads/pneuma-linux). You will need to mark these as executable after downloading.
